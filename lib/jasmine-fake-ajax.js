  ...
  function callAvailableCallbackHandlers(real, fake) {
    function checkPreCondition() {
      ...
      if (registeredCallbackRules.length === 0) {
        logAndThrow("Exactly one callback rule of [" + possibleCallbackRules.join(', ') + "] must be defined for url '" + real.url + "'. There was none.")
      } else if (registeredCallbackRules.length > 1) {
        logAndThrow("Exactly one callback rule of [" + possibleCallbackRules.join(', ') + "] must be defined for url '" + real.url + "'. There was " + registeredCallbackRules.length + ": [" + registeredCallbackRules.join(', ') + "].")
